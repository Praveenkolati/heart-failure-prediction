...
# Data columns
feature_names_best = ['age', 'sex', 'anaemia', 'creatinine_phosphokinase', 'diabetes', 'ejection_fraction',
                      'high_blood_pressure', 'platelets', 'serum_creatinine', 'serum_sodium', 'smoking', 'time']
...
html_temp = """
<div>
<h1 style="color:crimson;text-align:left;">Heart Failure Prediction Using Machine Learning</h1>
</div>
"""
...
feature_list = [age, get_value(sex, gender_dict), get_fvalue(anaemia), creatinine_phosphokinase, get_fvalue(
    diabetes), ejection_fraction, get_fvalue(high_blood_pressure), platelets, serum_creatinine, serum_sodium, get_fvalue(smoking), time]
pretty_result = {"Age": age, "Sex": sex, "Anaemia": anaemia, "Creatinine phosphokinase (mcg/L)": creatinine_phosphokinase, "Diabetes": diabetes, "Ejection fraction %": ejection_fraction, "High blood pressure": high_blood_pressure,
                 "Platelets (mcL)": platelets, "Serum creatinine (mg/dL)": serum_creatinine, "Serum sodium (mEq/L)": serum_sodium, "Smoking": smoking, "Time (follow-up-period)": time}
'''
